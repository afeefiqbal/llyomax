...
@section('content')
    ...
    <div class="page-heading">
        <div class="page-breadcrumb">
            <h1 class="page-title page-title-sep">Expense Bills</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="/admin/dashboard"><i class="la la-home font-20"></i></a>
                </li>
                <li class="breadcrumb-item">Accounts</li>
                <li class="breadcrumb-item">Expense Bills</li>
            </ol>
        </div>
        <div>
            <a href="expense-bills/create">
        ...
        $(document).on('click', '.delete', function() {
            swal({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "expense-bills/" + id,
                        method: 'DELETE',
                        success: function(result) {
                            swal(
                                'Deleted!',
                                'expense-bills has been deleted.',
                                'success'
                            );
