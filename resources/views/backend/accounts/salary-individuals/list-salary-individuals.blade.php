...
@section('content')
    ...
    <div class="page-heading">
        <div class="page-breadcrumb">
            <h1 class="page-title page-title-sep">Salary ofindividuals</h1>
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="/admin/dashboard"><i class="la la-home font-20"></i></a>
                </li>
                <li class="breadcrumb-item">Accounts</li>
                <li class="breadcrumb-item">Salary ofindividuals</li>
            </ol>
        </div>
        <div>
            <a href="salary-of-individuals/create">
        ...
        $(document).on('click', '.delete', function() {
            swal({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "salary-of-individuals/" + id,
                        method: 'DELETE',
                        success: function(result) {
                            swal(
                                'Deleted!',
                                'salary-of-individuals has been deleted.',
                                'success'
                            );
