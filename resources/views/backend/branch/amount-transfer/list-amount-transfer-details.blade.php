...
@section('content')
    ...
    <div class="page-heading">
        <div class="page-breadcrumb">
            <h1 class="page-title page-title-sep">Manager Transfer Amount Details</h1>
            <ol class="breadcrumb">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <input type="date" name="date" id="date"  class="col-sm-12 form-control"
                            placeholder=" Date" />
                    </div>
                    <div class="col-md-3">
                        <br>
      ...
      $(document).ready(function() {
            ...
            function load_data(date = '') {
                $('.data-table').DataTable({
                    ...
                    ajax: {
                        url: "/admin/branch/amount-transfer",
                        data: {
                            date: $('#date').val(),
                        }
                    },
