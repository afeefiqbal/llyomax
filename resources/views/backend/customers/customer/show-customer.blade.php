                    ...
                    <div>
                        <ul class="nav nav-tabs nav-top-border nav-tabs-lg">
                            ...
                            @hasanyrole('super-admin|developer-admin||office-administrator
                                ...
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-edit"><i
                                            class="ti-receipt nav-tabs-icon"></i>Customer Edit</a></li>
                            @endhasanyrole
                            @hasanyrole('super-admin|developer-admin||office-administrator
                                |branch-manager|collection-manager|marketing-manager')
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-assign"><i
                                        class="ti-receipt nav-tabs-icon"></i>Assign C.E</a></li>
                            @endhasanyrole
                        </ul>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card-body">
                                            <h5>Edit Customer</h5>
                                            <hr>
                                            <form action="/admin/customer/edit-customer/{{ $customer->id }}"
                                                method="POST" id="customer-edit-form">
                                                @csrf
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-3 form-group mb-4">
                                                        ...
                                                        <select name="area_id" class="select2 area_select2 form-control"
                                                            id="area">
                                                            <option value=""
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="card card-fullheight">
                                            <div class="card-header">
                                                <h4 class="card-title">Assign Collection Executive to Customer</h4>
                                            </div>
                                            <div class="card-body">
                                                <form action="/admin/customer/assignce" method="POST" id="collectionExecutive-form">
                                                    @csrf
                                                    <div class="row">
                                                        <div class="col-sm-4 form-group mb-4">
                                        ...
                                        <div class="alert alert-danger">
                                            <strong>Please assign customer Area first</strong>
                                        @endif
                                    </div>
                                    <div>
                                        <h5>Assigned Collection Executives</h5>
                                        <table class="table">
                                            <thead>
                                                <tr>
                                                    <th scope="col">#</th>
                                                    <th scope="col">Scheme ID</th>
                                                    <th scope="col">Scheme Name</th>
                                                    <th scope="col">Collection Executives</th>
                                                    <th scope="col">Action</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                @php
                                                    $n = 1;
                                                @endphp
                                                @foreach ($customerExcutivesAssigned as $ExcutivesAssigned)
                                                    <tr>
                                                        <td>{{ $n++ }}</td>
                                                        @php
                                                            $scheme = \App\Models\Scheme::where('id', $ExcutivesAssigned->scheme_id)->first();
                                                        @endphp
                                                        <td>{{ $scheme->scheme_a_id . '-' . $scheme->scheme_n_id }}</td>
                                                        <td>{{ $scheme->name }}</td>
                                                        <td>{{ $ExcutivesAssigned->executive->name }}</td>
                                                        <td>
                                                            <a href="/admin/branch/collection-executives/{{ $ExcutivesAssigned->id }}/edit" class="btn btn-warning btn-sm">Edit</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
...
@push('scripts')
    ...
    <script>
        ...
        //getting executives for the scheme assigning
        ...
        //saving executives for collection
