...
@section('content')
    ...
    <div class="page-heading">
        <div class="page-breadcrumb">
            <h1 class="page-title page-title-sep">Daily Report By Marketing Executive</h1>
            <ol class="breadcrumb">
            </ol>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-md-3">
                        <label>Date</label>
                        <input type="date" name="date" id="date" value="<?php echo date('Y-m-d'); ?>" class="col-sm-12 form-group" placeholder=" Date" />
                    </div>
        ...
        $(document).ready(function() {
            ...
            function load_data(date = '') {
                $('.data-table').DataTable({
                    ...
                    ajax: {
                        url: "/admin/reports/daily-report-by-executive",
                        data: {
                            date: $('#date').val(),
                            branch_id: $("#branch_id :selected").val(),
                            scheme_id: $("#scheme_id :selected").val(),
                            executive_id: $("#executive_id :selected").val(),
                        }
                    },
                    columns: [{
                            data: 'DT_RowIndex',
                        ...
                        {
                            data: 'date_for_1st_payement',
                            name: 'date_for_1st_payement'
                        },
                        {
                            data: 'status',
                            name: 'status'
            ...
            $('#filter').click(function() {
                ...
                if (date != '' ) {
                    ...
                    load_data(date, branch_id,scheme_id, executive_id);
                } else {
            ...
            $('#area_id').on('change', function() {
                ...
                if (area_id) {
                    ...
                    $.ajax({
                        url: "/admin/reports/get-executive",
                        method: 'GET',
                        data: {
                            "area_id": area_id,
                            "branch_id": branch_id,
