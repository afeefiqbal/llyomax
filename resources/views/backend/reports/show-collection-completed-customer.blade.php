...
@section('content')
    ...
    <div class="page-heading">
        ...
        <div>
            <a href="/admin/warehouse/collection-completed">
                ...
                <div class="card-body">
                    <div>
                        <ul class="nav nav-tabs nav-top-border nav-tabs-lg">
                            ...
                            <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#tab-orders"><i
                                        class="ti-menu nav-tabs-icon"></i>Order Details</a></li>
                        </ul>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-sm-4 form-group mb-4" id="edit-phone">
                                                                ...
                                                                <div class="input-group mb-4">
                                                                    ...
                                                                    <div class="input-group-append">
                                                                        <button class="btn btn-outline-success"
                                                                            type="button" onclick="validateOTP()">Validate
                                                                            OTP</button>
                                                                    </div>
                                                            ...
                                                            <div class="col-sm-3 form-group mb-4">
                                                                ...
                                                                <textarea class="form-control" name="address" id="address" cols="5"
                                                                    rows="6">{{ isset($customer) ? $customer->address : old('address') }}</textarea>
                                                            </div>
                                                            <div class="col-sm-3 form-group mb-4">
                                                                <br>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($customerOrders as $customerOrder)
                                        <tr>
                                            ...
                                            <td>{{ $customerOrder->net_amount }}</td>
